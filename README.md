...
Географический каталог содержит около **34 000 городов в 252 странах**:
до 15 крупнейших городов небольшой страны и до 50 — большой. Координаты и
перечень городов берём из локальной базы GeoNames, но каждый маршрут, цену и
дату всё равно подтверждает Туту.
...
Города, не прошедшие фильтры, не исчезают, а гаснут до `#8f8caa`: пропадающие
точки рвут связь с выбранным маршрутом и скрывают важное — что дальше денег
уже не хватает.
